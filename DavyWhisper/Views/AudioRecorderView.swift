...
struct AudioRecorderView: View {
    ...
    var body: some View {
        Form {
            ...
            Section(String(localized: "recorder.sources")) {
                ...
                Text(String(localized: "Affects only DavyWhisper recordings and transcriptions, not your live meeting microphone."))
                    .font(.caption)
                    .foregroundStyle(.secondary)
            }
    ...
    private var isLiveTranscriptPluginActive: Bool {
        pluginManager.loadedPlugins.contains { $0.manifest.id == "com.davywhisper.livetranscript" && $0.isEnabled }
    }
}
