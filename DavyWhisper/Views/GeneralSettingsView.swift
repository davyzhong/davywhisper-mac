    ...
    var body: some View {
        Form {
            ...
            Section(String(localized: "Startup")) {
                ...
                Text(String(localized: "DavyWhisper will start automatically when you log in."))
                    .font(.caption)
                    .foregroundStyle(.secondary)
            }
        ...
        .alert(String(localized: "Restart Required"), isPresented: $showRestartAlert) {
            ...
            Text(String(localized: "The language change will take effect after restarting DavyWhisper."))
        }
        .alert(String(localized: "Menu bar icon hidden"), isPresented: $showMenuBarIconHiddenAlert) {
            Button(String(localized: "OK"), role: .cancel) {}
        } message: {
            Text(String(localized: "You can access DavyWhisper settings via the Dock icon."))
        }
    }
