...
private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "davywhisper-mac", category: "AudioRecordingService")
...
final class AudioRecordingService: ObservableObject, @unchecked Sendable {
    ...
    private let processingQueue = DispatchQueue(label: "com.davywhisper.audio-processing", qos: .userInteractive)
