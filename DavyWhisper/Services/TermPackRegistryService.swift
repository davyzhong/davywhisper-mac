...
private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "DavyWhisper", category: "TermPackRegistry")
...
final class TermPackRegistryService: ObservableObject {
    ...
    init(
        registryURL: URL = URL(string: "https://davywhisper.github.io/davywhisper-mac/termpacks.json")!,
