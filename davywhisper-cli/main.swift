...
func printUsage() {
    let usage = """
        Usage: davywhisper <command> [options]
        ...
        Global options:
          ...
          --dev                Connect to DavyWhisper Dev instance
          --json               Output as JSON
          --help, -h           Show help
        ...
        Examples:
          davywhisper status
          davywhisper transcribe recording.wav
          davywhisper transcribe recording.wav --language zh --json
          davywhisper transcribe - < audio.wav
