...
public protocol DavyWhisperPlugin: AnyObject, Sendable {
...
public extension DavyWhisperPlugin {
...
public protocol PluginSettingsActivityReporting: DavyWhisperPlugin {
...
public protocol LLMProviderPlugin: DavyWhisperPlugin {
...
public protocol TranscriptionEnginePlugin: DavyWhisperPlugin {
