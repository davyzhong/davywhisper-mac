...
// CohereTranscribe removed - not available in xcframework v1.12.34
...
class SourceSeparator {
  ...
  func process(buffer: SherpaAudioData) -> [SherpaAudioData]? {
